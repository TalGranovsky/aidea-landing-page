      ...
      <main className="min-h-screen bg-black text-white">
        ...
        <div className="pt-24 pb-16">
          <div className="max-w-7xl 2k:max-w-[1800px] 4k:max-w-[2400px] mx-auto px-4 sm:px-6 lg:px-8 2k:px-12 4k:px-16">
            ...
            {/* About Section */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20 2k:mb-28 4k:mb-36">
              <motion.div
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.6, delay: 0.2 }}
              >
                <h2 className={`text-3xl md:text-4xl 2k:text-5xl 4k:text-6xl font-bold mb-6 2k:mb-8 4k:mb-10 ${playfair.className}`}>Our Story</h2>
                <p className="text-neutral-300 mb-4 2k:text-xl 4k:text-2xl 2k:mb-6 4k:mb-8">
                ...
                <p className="text-neutral-300 2k:text-xl 4k:text-2xl">
              ...
              <motion.div
                ...
                className="relative h-[400px] 2k:h-[500px] 4k:h-[600px] rounded-xl overflow-hidden"
              >
            ...
            <motion.div
              ...
              className="grid grid-cols-1 md:grid-cols-2 gap-8 2k:gap-12 4k:gap-16 mb-20 2k:mb-28 4k:mb-36"
            >
              <div className="bg-neutral-900/50 backdrop-blur-sm rounded-xl border border-neutral-800 p-8 2k:p-10 4k:p-12">
                <div className="w-16 h-16 2k:w-20 2k:h-20 4k:w-24 4k:h-24 bg-purple-900/40 rounded-full mb-6 2k:mb-8 4k:mb-10 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 2k:w-10 2k:h-10 4k:w-12 4k:h-12">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                </div>
                <h3 className={`text-2xl 2k:text-3xl 4k:text-4xl font-bold mb-4 2k:mb-6 4k:mb-8 ${playfair.className}`}>Our Vision</h3>
                <p className="text-neutral-400 2k:text-lg 4k:text-xl">
              ...
              <div className="bg-neutral-900/50 backdrop-blur-sm rounded-xl border border-neutral-800 p-8 2k:p-10 4k:p-12">
                <div className="w-16 h-16 2k:w-20 2k:h-20 4k:w-24 4k:h-24 bg-blue-900/40 rounded-full mb-6 2k:mb-8 4k:mb-10 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 2k:w-10 2k:h-10 4k:w-12 4k:h-12">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" />
                  </svg>
                </div>
                <h3 className={`text-2xl 2k:text-3xl 4k:text-4xl font-bold mb-4 2k:mb-6 4k:mb-8 ${playfair.className}`}>Our Mission</h3>
                <p className="text-neutral-400 2k:text-lg 4k:text-xl">
            ...
            <motion.div
              ...
              className="mb-20 2k:mb-28 4k:mb-36"
            >
              <h2 className={`text-3xl md:text-4xl 2k:text-5xl 4k:text-6xl font-bold mb-10 text-center ${playfair.className}`}>Our Team</h2>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 2k:gap-10 4k:gap-12">
                {/* Team Member 1 */}
                <div className="bg-neutral-900/50 backdrop-blur-sm rounded-xl border border-neutral-800 hover:border-purple-500/70 overflow-hidden group team-card metallic-shine">
                  <div className="h-64 bg-neutral-800 relative overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4 z-20">
                      <h3 className="text-xl 2k:text-2xl 4k:text-3xl font-bold">Alex Morgan</h3>
                      <p className="text-neutral-400 text-sm 2k:text-base 4k:text-lg">Founder &amp; CEO</p>
                    </div>
                  ...
                  <div className="p-4 relative z-10">
                    <p className="text-neutral-400 text-sm 2k:text-base 4k:text-lg">
                ...
                <div className="bg-neutral-900/50 backdrop-blur-sm rounded-xl border border-neutral-800 hover:border-purple-500/70 overflow-hidden group team-card metallic-shine">
                  <div className="h-64 bg-neutral-800 relative overflow-hidden">
                    ...
                    <div className="absolute -inset-1 bg-gradient-to-r from-purple-600/20 via-transparent to-blue-600/20 rounded-xl blur-xl opacity-0 group-hover:opacity-70 transition-opacity duration-1000 animate-gradient-shift z-5"></div>
                    <div className="absolute bottom-4 left-4 z-20">
                      <h3 className="text-xl 2k:text-2xl 4k:text-3xl font-bold">Samantha Chen</h3>
                      <p className="text-neutral-400 text-sm 2k:text-base 4k:text-lg">Creative Director</p>
                    </div>
                    {/* Placeholder for team member image */}
                    <div className="absolute inset-0 bg-neutral-700 z-0 group-hover:scale-105 transition-transform duration-500"></div>
                  </div>
                ...
                <div className="bg-neutral-900/50 backdrop-blur-sm rounded-xl border border-neutral-800 hover:border-purple-500/70 overflow-hidden group team-card metallic-shine">
                  <div className="h-64 bg-neutral-800 relative overflow-hidden">
                    ...
                    <div className="absolute -inset-1 bg-gradient-to-r from-purple-600/20 via-transparent to-blue-600/20 rounded-xl blur-xl opacity-0 group-hover:opacity-70 transition-opacity duration-1000 animate-gradient-shift z-5"></div>
                    <div className="absolute bottom-4 left-4 z-20">
                      <h3 className="text-xl 2k:text-2xl 4k:text-3xl font-bold">Marcus Johnson</h3>
                      <p className="text-neutral-400 text-sm 2k:text-base 4k:text-lg">Technical Lead</p>
                    </div>
                    {/* Placeholder for team member image */}
                    <div className="absolute inset-0 bg-neutral-700 z-0 group-hover:scale-105 transition-transform duration-500"></div>
                  </div>
                ...
                <div className="bg-neutral-900/50 backdrop-blur-sm rounded-xl border border-neutral-800 hover:border-purple-500/70 overflow-hidden group team-card metallic-shine">
                  <div className="h-64 bg-neutral-800 relative overflow-hidden">
                    ...
                    <div className="absolute -inset-1 bg-gradient-to-r from-purple-600/20 via-transparent to-blue-600/20 rounded-xl blur-xl opacity-0 group-hover:opacity-70 transition-opacity duration-1000 animate-gradient-shift z-5"></div>
                    <div className="absolute bottom-4 left-4 z-20">
                      <h3 className="text-xl 2k:text-2xl 4k:text-3xl font-bold">Olivia Kim</h3>
                      <p className="text-neutral-400 text-sm 2k:text-base 4k:text-lg">AI Researcher</p>
                    </div>
                    {/* Placeholder for team member image */}
                    <div className="absolute inset-0 bg-neutral-700 z-0 group-hover:scale-105 transition-transform duration-500"></div>
                  </div>
